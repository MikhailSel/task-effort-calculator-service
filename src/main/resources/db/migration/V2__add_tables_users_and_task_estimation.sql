...
comment on column task_estimation.task_id is 'task ID';
comment on column task_estimation.user_id is 'user ID';
comment on column task_estimation.days_per_person is 'days per person';
